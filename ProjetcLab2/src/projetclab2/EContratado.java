...
public class EContratado extends Empleado {
    ...
    public EContratado (String dui, String nombre, String apellidos, java.util.GregorianCalendar fechaIngreso, float salarioB) {
        super(dui, nombre, apellidos, fechaIngreso);
